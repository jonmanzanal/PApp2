...
from undreamt.translator2 import Translator
...
class Trainer:
    ...
    def step(self):
        ...
        losscos=cos(hidden.view(-1,hidden.shape[-1]),self.corpus.hidden.view(-1,self.corpus.hidden.shape[-1]),torch.ones(hidden.shape[0],hidden.shape[1]))
